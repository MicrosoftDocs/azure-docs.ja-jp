---
title: Azure DNS Private Zone パブリック プレビュー通知のインクルード ファイル
description: Azure DNS Private Zone パブリック プレビュー通知のインクルード ファイル
services: dns
author: subsarma
ms.service: dns
...
ms.locfileid: "67181804"
---
> [!IMPORTANT]
> Azure DNS Private Zone 機能は現在パブリック プレビュー段階です。 
>

...
|[Microsoft Azure のコンテナーのセキュリティ](abstract-container-security-microsoft-azure.md)|コンテナー、コンテナーのデプロイと管理、ネイティブ プラットフォーム サービスについて説明します。 また、Azure プラットフォーム上でコンテナーを使用する際に発生するランタイム セキュリティの問題についても説明します。 |
|[Azure の運用上のセキュリティ](abstract-azure-operational-security.md)|Azure で利用できる顧客向けの運用上のセキュリティ テクノロジとサービスについて、包括的に説明します。|

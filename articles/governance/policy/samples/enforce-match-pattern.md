...
ms.locfileid: "59266632"
---
# <a name="sample---enforce-match-pattern-for-naming-conventions"></a>サンプル - 名前付け規則の一致パターンを強制する

リソース名は名前付け規則に対する一致パターンを満たしている必要があります。 許可される一致パターンをパラメーターとして指定します。

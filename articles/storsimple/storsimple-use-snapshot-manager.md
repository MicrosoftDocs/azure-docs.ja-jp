...
| Edit |**[バックアップ ポリシー]** をクリックし、**結果**ウィンドウでポリシーを右クリックします。 |ボリューム グループのバックアップ スケジュールを変更するには、 **[編集]** をクリックします。 |
...
| [Help] |任意のノードまたは結果をクリックします (この項目は、すべての **[操作]** メニューと **[操作]** ウィンドウに表示されます)。 |別のブラウザー ウィンドウでオンライン ヘルプを開くには、 **[ヘルプ]** をクリックします。 |

...
ms.locfileid: "67604317"
---
# <a name="quickstart-analyze-a-remote-image-using-the-computer-vision-rest-api-and-php"></a>クイック スタート:Computer Vision の REST API と PHP を使用してリモート画像を分析する
